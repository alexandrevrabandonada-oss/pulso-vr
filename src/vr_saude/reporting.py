    ...
    report.write_text(
        "\n".join(
            [
                ...
                "- O denominador populacional agregado já pode ser integrado; taxas específicas "
                "do SIH exigem uma extração com idade/sexo, que não está nesta Lista Morb agregada.",
