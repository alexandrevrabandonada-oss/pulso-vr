...
export function MethodsPage() {
  ...
  return (
    <main className="content-page methods-page">
      ...
      <section className="method-columns"><div><h2>Comparadores</h2><p>Cada município é comparado ao agregado do RJ excluindo o próprio município selecionado e ao Brasil quando numerador e denominador forem equivalentes. “Média estadual” não é uma média simples das taxas municipais.</p></div><div><h2>Taxas</h2><p>A interface nomeia taxas brutas explicitamente. Taxas padronizadas só serão oferecidas quando usarem o mesmo padrão etário e denominadores compatíveis. Razões e diferenças são descritivas.</p></div><div><h2>Supressão</h2><p>Células com contagem menor que {release.smallCellThreshold} são removidas antes da publicação. O navegador nunca recebe seus números.</p></div></section>
