...
describe('ExplorerFilters', () => {
  it('changes the metric through a real button control', () => {
    ...
    render(<ExplorerFilters theme="respiratory" indicators={[indicator]} indicatorId={indicator.id} territory="all" metric="crude_rate_per_100k" startYear={2008} endYear={2025} onTheme={vi.fn()} onIndicator={vi.fn()} onTerritory={vi.fn()} onMetric={onMetric} onStartYear={vi.fn()} onEndYear={vi.fn()} />)
  ...
  it('exposes disabled age and sex controls honestly', () => {
    render(<ExplorerFilters theme="respiratory" indicators={[indicator]} indicatorId={indicator.id} territory="all" metric="crude_rate_per_100k" startYear={2008} endYear={2025} onTheme={vi.fn()} onIndicator={vi.fn()} onTerritory={vi.fn()} onMetric={vi.fn()} onStartYear={vi.fn()} onEndYear={vi.fn()} />)
  ...
  it('changes the territory comparison through the public filter', () => {
    ...
    render(<ExplorerFilters theme="respiratory" indicators={[indicator]} indicatorId={indicator.id} territory="all" metric="crude_rate_per_100k" startYear={2008} endYear={2025} onTheme={vi.fn()} onIndicator={vi.fn()} onTerritory={onTerritory} onMetric={vi.fn()} onStartYear={vi.fn()} onEndYear={vi.fn()} />)
